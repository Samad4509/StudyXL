...
class AgentStudentController extends Controller
{
    ...
    {
        return $agentstudent = AgentStudent::all();
    }
    ...
    public function store(Request $request)
    {
        ...
        // Format dates
        $dob = $request->filled('dob') ? Carbon::createFromFormat('m-d-Y', $request->dob)->format('Y-m-d') : null;
        $passportExpiry = $request->filled('passport_expiry') ? Carbon::createFromFormat('m-d-Y', $request->passport_expiry)->format('Y-m-d') : null;
        ...
        foreach ($jsonFields as $field) {
            ...
            if (is_string($value)) {
                ...
                $jsonData[$field] = json_last_error() === JSON_ERROR_NONE ? $decoded : [];
            } else {
